...
This app modifies 36 framework files and adds 4 more under `src/toolcraft/`.
...
`src/toolcraft/` exactly: all 664 files hash-identical, 0 differing, nothing
...
Six of the 40 are not timeline work and should be judged separately.
