...
This app modifies 33 framework files and adds 4 more under `src/toolcraft/`.
...
`src/toolcraft/` exactly: 37 of 37 files hash-identical, 0 differing. The
...
Six of the 37 are not timeline work and should be judged separately.
